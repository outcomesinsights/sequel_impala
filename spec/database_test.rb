...
describe Sequel::Database do
  ...
  describe "constraint violations" do
    ...
    it "should raise Sequel::UniqueConstraintViolation when a unique constraint is violated" do
    ...
    it "should raise Sequel::UniqueConstraintViolation when a unique constraint is violated for composite primary keys" do
    ...
    it "should raise Sequel::CheckConstraintViolation when a check constraint is violated" do
    ...
    it "should raise Sequel::ForeignKeyConstraintViolation when a foreign key constraint is violated"  do
    ...
    it "should raise Sequel::NotNullConstraintViolation when a not null constraint is violated" do
